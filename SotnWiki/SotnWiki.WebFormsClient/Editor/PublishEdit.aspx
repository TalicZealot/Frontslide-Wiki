<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PublishEdit.aspx.cs" Inherits="SotnWiki.WebFormsClient.PublishEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="content">
        ...
        <asp:Button ID="publishEdit" Text="Publish" runat="server" OnClick="publishEdit_Click" />
        <asp:Button ID="dismissEdit" Text="Dismiss" runat="server" OnClick="dismissEdit_Click" />
    </div>
