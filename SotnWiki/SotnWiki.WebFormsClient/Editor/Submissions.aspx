<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Submissions.aspx.cs" Inherits="SotnWiki.WebFormsClient.Submissions" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="content">
        <h1>Pending page submissions</h1>
        <asp:ListView
            ...
            <ItemTemplate>
                <div class="result">
                    <a href="/editor/publish?title=<%#: Item.Title.ToLower().Replace(' ', '-') %>">
                        <h2><%#: Item.Title %></h2>
                    </a>
                    <p>
