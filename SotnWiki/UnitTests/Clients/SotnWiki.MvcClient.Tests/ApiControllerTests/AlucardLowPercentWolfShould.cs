...
{
    [TestFixture]
    public class AlucardLowPercentWolfShould
    {
        [Test]
        public void ReturnsObjectOfTypeJsonResult()
        {
            ...
            //Act
            var result = controllerUnderTest.AlucardLowPercentWolf();
        ...
        public void ReturnCorrectOrderedJsonCollection()
        {
            ...
            //Act
            var result = controllerUnderTest.AlucardLowPercentWolf() as JsonResult;
