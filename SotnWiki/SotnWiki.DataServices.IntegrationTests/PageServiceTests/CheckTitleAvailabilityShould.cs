...
This wiki uses TxStyle markup, for reference visit  ""https://txstyle.org/"":https://txstyle.org/.";
        ...
        [Test]
        public void ReturnCorrectValue_WhenNameIsNotFound()
        {
            //Arrange
            IPageService pageService = kernel.Get<IPageService>();

            //Act
            var result = pageService.CheckTitleAvailability("asasftfd");
        ...
        [Test]
        public void ReturnCorrectValue_WhenNameIsFound()
        {
            //Arrange
            IPageService pageService = kernel.Get<IPageService>();

            //Act
            var result = pageService.CheckTitleAvailability("Main Page");
