...
This wiki uses TxStyle markup, for reference visit  ""https://txstyle.org/"":https://txstyle.org/.";
        ...
        [Test]
        public void ReturnNull_WhenPageIsNotFound()
        {
            //Arrange
            IPageService pageService = kernel.Get<IPageService>();

            //Act
            var result = pageService.GetPageByTitle("asasftfd");
        ...
        [Test]
        public void ReturnCorrectProjectedPage_WhenPageIsFound()
        {
            //Arrange
            IPageService pageService = kernel.Get<IPageService>();

            //Act
            var result = pageService.GetPageByTitle("Main Page");
